...
<script>
import { listSensitive, getSensitive, delSensitive, addSensitive, updateSensitive } from "@/api/system/sensitive";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除敏感词编号为"' + ids + '"的数据项？').then(function() {
