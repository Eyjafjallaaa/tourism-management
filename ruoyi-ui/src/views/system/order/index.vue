<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="出行人数" align="center" prop="num" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="景点名" prop="sname">
          <el-input v-model="form.sname" placeholder="请输入景点名" />
        </el-form-item>
        <el-form-item label="订单价格" prop="price">
          <el-input v-model="form.price" placeholder="请输入订单价格" />
        </el-form-item>
        <el-form-item label="出行人数" prop="num">
          <el-input v-model="form.num" placeholder="请输入出行人数" />
        </el-form-item>
      </el-form>
